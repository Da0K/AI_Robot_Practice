...
def main(args=None):
    ...
    for i in range(len(cube_list)):
        ...
        robot.move_l(grasp_ready_pose) # For preventing skipping problem
        ...
        for current_z in range(start_z - 5, target_z - 1, -5): # if grasp_pose changes, it changes too.
            step_pose = grasp_ready_pose.copy()
            step_pose[2] = float(current_z)

            amovel(step_pose, vel=10, acc=10) # DSL Robot 2 function - async movel
